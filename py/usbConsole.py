...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(320, 460)
        #设置窗体置顶和只显示关闭按钮
        Form.setWindowFlags(QtCore.Qt.WindowStaysOnTopHint|QtCore.Qt.WindowCloseButtonHint)
